...
(function(global, factory) {
  ...
  let Carousel =
    ...
    (function() {
      ...
      _proto._setActiveIndicatorElement = function _setActiveIndicatorElement(
        ...
        let indicators = [].slice.call(this._indicatorsElement.querySelectorAll(Selector$2.ACTIVE));
  ...
  let Collapse =
    ...
    (function() {
      function Collapse(element, config) {
        ...
        let filterElement = [].slice.call(document.querySelectorAll(selector)).filter((foundElem) => {
  ...
  function allowedAttribute(attr, allowedAttributeList) {
    ...
    let regExp = allowedAttributeList.filter((attrRegex) => {
  ...
  let Tab =
    ...
    (function() {
      ...
      _proto.show = function show() {
        ...
        var target;
        let previous;
      let listElement = $(this._element).closest(Selector$9.NAV_LIST_GROUP)[0];
        ...
        var complete = function complete() {
          let hiddenEvent = $.Event(Event$9.HIDDEN, {
            relatedTarget: _this._element,
          });
          let shownEvent = $.Event(Event$9.SHOWN, {
            relatedTarget: previous,
          });
