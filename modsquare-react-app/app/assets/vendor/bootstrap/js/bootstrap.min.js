    ...
    return (
      ...
      (t._removeElement = function(e) {
        ...
        if ((g(e).removeClass(m), g(e).hasClass(d))) {
          ...
          g(e)
            .one(_.TRANSITION_END, (t) => n._destroyElement(e, t))
    ...
    return (
      ...
      (t.to = function(t) {
        ...
        if (!(t > this._items.length - 1 || t < 0))
          if (this._isSliding)
            g(this._element).one(Q.SLID, () => e.to(t));
          else {
      ...
      (t._addEventListeners = function() {
        ...
        this._config.keyboard &&
          g(this._element).on(Q.KEYDOWN, t => e._keydown(t)),
    ...
    return (
      ...
      (c._clearMenus = function(t) {
        if (!t || (t.which !== 3 && (t.type !== 'keyup' || t.which === 9)))
          for (
            let e = [].slice.call(document.querySelectorAll(Ut)),
              n = 0,
              i = e.length;
            n < i;
            n++
    ...
    return (
      ...
      (t.show = function(t) {
        ...
        if (!this._isShown && !this._isTransitioning) {
          ...
          const n = g.Event(re.SHOW, { relatedTarget: t });
          ...
          this._isShown ||
              ...
              g(this._element).on(re.CLICK_DISMISS, _e, t => e.hide(t)),
              g(this._dialog).on(re.MOUSEDOWN_DISMISS, () => {
                g(e._element).one(re.MOUSEUP_DISMISS, (t) => {
      ...
      (t.hide = function(t) {
        ...
        if (
          ...
          if (
            ...
            this._isShown = !1;
            let i = g(this._element).hasClass(he);
            if (
              ...
              g(this._element)
                .one(_.TRANSITION_END, (t) => e._hideModal(t))
      ...
      (t._setResizeEvent = function() {
        let e = this;
        this._isShown
          ? g(window).on(re.RESIZE, (t) => e.handleUpdate(t))
      ...
      (t._setScrollbar = function() {
        ...
        if (this._isBodyOverflowing) {
          let t = [].slice.call(document.querySelectorAll(me));
...
var i = g(e).css('margin-right');
      ...
      (t._resetScrollbar = function() {
        ...
        g(t).each((t, e) => {
          let n = g(e).data('padding-right');
          g(e).removeData('padding-right'), (e.style.paddingRight = n || '');
        });
        let e = [].slice.call(document.querySelectorAll(`${  pe}`));
        g(e).each((t, e) => {
          let n = g(e).data('margin-right');
          'undefined' !== typeof n &&
            g(e)
              .css('margin-right', n)
      ...
      (t.hide = function(t) {
        ...
        if ((g(this.element).trigger(i), !i.isDefaultPrevented())) {
          if (
            ...
            let r = _.getTransitionDurationFromElement(n);
            g(n)
              .one(_.TRANSITION_END, o)
              .emulateTransitionEnd(r);
          } else o();
...
var n =
      ...
      (t._enter = function(t, e) {
        ...
        t && (e._activeTrigger[t.type === 'focusin' ? Me : qe] = !0),
      ...
      (t._leave = function(t, e) {
        ...
        (e = e || g(t.currentTarget).data(n)) ||
          ...
          g(t.currentTarget).data(n, e)),
        t && (e._activeTrigger[t.type === 'focusout' ? Me : qe] = !1),
  ...
  var Ze = l({}, Be.DefaultType, { content: '(string|element|function)' });
  ...
  var un = { offset: 10, method: 'auto', target: '' };

  var fn = { offset: 'number', method: 'string', target: '(string|element)' };
  ...
  var Dn = (function() {
    function n(t, e) {
      ...
      (this._config = this._getConfig(e)),
      (this._selector = `${this._config.target} ${vn},${
              this._config.target 
      ...
      g(this._scrollElement).on(dn.SCROLL, t => n._process(t)),
      this.refresh(),
      this._process();
    }
    const t = n.prototype;
...
var n = _.getSelectorFromElement(t);
      ...
      (t._getConfig = function(t) {
        if (
          typeof (t = l({}, un, typeof t == 'object' && t ? t : {})).target !==
          'string'
        ) {
  ...
  g(window).on(dn.LOAD_DATA_API, () => {
    for (
      let t = [].slice.call(document.querySelectorAll(mn)), e = t.length;
      e--;
    ...
    return (
      (t.show = function() {
        ...
        if (
          ...
          if (e) {
            const r = e.nodeName === 'UL' || e.nodeName === 'OL' ? Un : Fn;
            i = (i = g.makeArray(g(e).find(r)))[i.length - 1];
          }
          const s = g.Event(On.HIDE, { relatedTarget: this._element });

          var a = g.Event(On.SHOW, { relatedTarget: i });
          if (
            (i && g(i).trigger(s),
            ...
            let l = function() {
              const t = g.Event(On.HIDDEN, { relatedTarget: n._element });

              var e = g.Event(On.SHOWN, { relatedTarget: i });
      ...
      (t._activate = function(t, e, n) {
        ...
        if (o && r) {
          const a = _.getTransitionDurationFromElement(o);
          g(o)
            .removeClass(Hn)
      ...
      (t._transitionComplete = function(t, e, n) {
        if (e) {
          g(e).removeClass(Pn);
          const i = g(e.parentNode).find(Mn)[0];
        ...
        if (
          ...
          const o = g(t).closest(Rn)[0];
          if (o) {
            let r = [].slice.call(o.querySelectorAll(qn));
            g(r).addClass(Pn);
          }
      ...
      (i._jQueryInterface = function(n) {
        return this.each(function() {
          ...
          var e = t.data(wn);
          if (
            (e || ((e = new i(this)), t.data(wn, e)), typeof n === 'string')
          ) {
  ...
  var Zn = { animation: 'boolean', autohide: 'boolean', delay: 'number' };

  var ti = { animation: !0, autohide: !0, delay: 500 };
  ...
  var ni = (function() {
    ...
    return (
      ...
      (t._setListeners = function() {
        const t = this;
        g(this._element).on(zn.CLICK_DISMISS, ei, () => t.hide(!0));
      }),
      (t._close = function() {
        let t = this;
      ...
      (i._jQueryInterface = function(n) {
        return this.each(function() {
          ...
          if (
            (e ||
                ((e = new i(this, typeof n === 'object' && n)), t.data(Bn, e)),
            typeof n === 'string')
          ) {
            if (typeof e[n] === 'undefined')
              throw new TypeError(`No method named "${  n  }"`);
