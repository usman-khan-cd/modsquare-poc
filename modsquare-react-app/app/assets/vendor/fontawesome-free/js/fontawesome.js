...
(function() {
  ...
  const RESERVED_CLASSES = [
    ...
    .concat(
      oneToTen.map(n => ''.concat(n, 'x')),
    )
    .concat(
      oneToTwenty.map(n => 'w-'.concat(n)),
    );
  ...
  function observe(options) {
    ...
    let nodeCallback = options.nodeCallback;

    let pseudoElementsCallback = options.pseudoElementsCallback;
...
var mask = _ref2[1];
  ...
  function replaceForPosition(node, position) {
    ...
    return new picked((resolve, reject) => {
      ...
      let alreadyProcessedPseudoElement = children.filter((c) => {
  ...
  const text = function text(content) {
    ...
    let _params$title2 = params.title;

    let title = _params$title2 === void 0 ? null : _params$title2;

    let _params$classes2 = params.classes;

    let classes = _params$classes2 === void 0 ? [] : _params$classes2;

    let _params$attributes2 = params.attributes;

    let attributes = _params$attributes2 === void 0 ? {} : _params$attributes2;

    let _params$styles2 = params.styles;

    let styles = _params$styles2 === void 0 ? {} : _params$styles2;
    return apiObject(
      {
        type: 'text',
        content,
  ...
  const counter = function counter(content) {
    ...
    let classes = _params$classes3 === void 0 ? [] : _params$classes3;

    let _params$attributes3 = params.attributes;

    let attributes = _params$attributes3 === void 0 ? {} : _params$attributes3;

    let _params$styles3 = params.styles;

    let styles = _params$styles3 === void 0 ? {} : _params$styles3;
    return apiObject(
      {
        type: 'counter',
        content,
